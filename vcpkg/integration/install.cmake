...
if(_profile STREQUAL "static-third-party")
    ...
    if(_mode STREQUAL "release-import" AND NOT VCPKG_TARGET_IS_WINDOWS)
        message(FATAL_ERROR "static-third-party release reuse is Windows-only; Linux requires the frozen source-built platform graph")
    endif()
